# Generated by Django 3.1.1 on 2020-10-21 19:50
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('grain', models.CharField(blank=True, max_length=8, null=True)),
                ('grain_amount', models.FloatField(blank=True, null=True)),
                ('hay', models.CharField(blank=True, max_length=100, null=True)),
                ('hay_amount', models.FloatField(blank=True, null=True)),
                ('horse_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='backoffice.horse')),
            ],
            options={
                'verbose_name': 'Feed',
